...
/*-----------------------------------------------------------
IC mapping code, everyone IC is 8 bit, HSB 4 bit description same serial, LSB 4 bit to separate spcific IC
-----------------------------------------------------------*/
enum IC_Type
{
	IC_FT5X36 = 0x10,
...
struct stTestItem
{
	unsigned char ItemType;//test class 	CfgItem, DataTestItem, GraphTestItem,
	unsigned char TestNum;//test serial number
	unsigned char TestResult;//test result,NG\PASS\TESTING
	unsigned char ItemCode;//test item code
	//CString strItemName;//test item name
	//CString strRemark;//comment
};
